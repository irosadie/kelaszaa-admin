...
class NotificationTemplates extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['code'], 'string', 'max' => 15],
            [['parent_id'], 'exist', 'skipOnError' => true, 'targetClass' => NotificationTemplates::className(), 'targetAttribute' => ['parent_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasMany(NotificationTemplates::className(), ['parent_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(NotificationTemplates::className(), ['id' => 'parent_id']);
    }
}
