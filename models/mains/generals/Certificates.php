 ...
 * @property int|null $certificate_full
...
class Certificates extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['id'], 'required'],
            [['id', 'class_id', 'certificate_file', 'certificate_full', 'can_download', 'status', 'created_at', 'created_by', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'member_id'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'certificate_full' => Yii::t('app', 'Certificate Full'),
