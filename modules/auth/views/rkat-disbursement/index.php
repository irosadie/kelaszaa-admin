                        ...
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'value' => function ($model) {
                                        return "<p class='tw-mb-1 tw-bg-blue-400 tw-px-3 tw-py-1 tw-rounded-full tw-whitespace-nowrap tw-text-white tw-text-xs tw-w-fit'>{$model->school->nama}</p>";
                                    }
                                ],
                                [
                                    'attribute' => 'status',
                                ...
                                [
                                    ...
                                    'template' => Yii::$app->users->can(["operator", "school_treasurer", "headmaster", "person_responsible"]) ? '{view}' : '',
                                    'buttons' => array(
