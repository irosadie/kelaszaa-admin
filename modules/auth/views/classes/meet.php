            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        ...
                        <?= Yii::$app->users->can([]) ? Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app', 'jadwal'), ['add-meet', 'code' => Yii::$app->encryptor->encodeUrl($model->id)], ['class' => 'btn btn-info m-1', 'id' => 'add-meet', 'data-title' => Yii::t('app', 'Tambah Member Ke Kelas')]) : "" ?>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <div class="alert alert-primary alert-has-icon alert-dismissible show fade">
                            ...
                            <div class="alert-body">
                                ...
                                <span>Fitur ini dalam pengembangan</span>
                            </div>
                        </div>
                        <?php GridView::widget([
...
$('a#add-meet').click(function(e){
    e.preventDefault();
    Swal.fire('Oups','Fitur ini dalam pengembangan','warning')
