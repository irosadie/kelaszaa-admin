...
<div class="row">
    <div class="col-12 col-lg-8 col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <?= $form->field($model, 'name', Template::template('fas fa-hashtag'))->textInput(['maxlength' => true, 'placeholder' => Yii::t('app', 'Nama Juknis')])->label(Yii::t('app', 'Nama Juknis')) ?>
                <?= $form->field($model, 'desc')->textArea(['maxlength' => true, 'placeholder' => '', 'class' => 'form-control'])->label(Yii::t('app', 'Desc')) ?>
                <?= $form->field($model, 'schools')->dropDownList($schools ?? [], ['class' => 'form-control get-schools select2', 'multiple' => true, 'value' => isset($schools) ? array_keys($schools) : [], 'prompt' => '--choose one--'])->label(Yii::t('app', 'Sekolah')); ?>
            </div>
        </div>
    </div>
                ...
                <div class="form">
                    <div class="authPrivacy">
                        <?= $form->field($model, 'year')
                            ->dropDownList($year ?? [], ['class' => 'form-control select2', 'value' => $model->isNewRecord ? date('Y') : $model->year, 'prompt' => '--choose one--'])->label(Yii::t('app', 'Tahun Anggaran')); ?>
                    </div>
