    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body col-7 m-auto">
                <?= $form->field($model, 'name', Template::template('fas fa-hashtag'))->textInput(['maxlength' => true, 'placeholder' => Yii::t('app', 'Nama Pengaturan')])->label(Yii::t('app', 'Nama')) ?>
                <?= $form->field($model, 'desc')->textArea(['maxlength' => true, 'placeholder' => '', 'class' => 'form-control'])->label(Yii::t('app', 'Deskripsi')) ?>
                <?= $form->field($model, 'year')->dropDownList($year ?? [], ['class' => 'form-control select2', 'prompt' => '--choose one--', 'disabled' => $model->isNewRecord ? false : true])->label(Yii::t('app', 'Tahun')); ?>
