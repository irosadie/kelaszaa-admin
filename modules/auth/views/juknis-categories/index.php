...
<div class="index">
    <div class="row">
        <div class="col-12">
            <p>
                <?= Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app', 'Kategori Juknis'), ['create'], ['class' => 'btn btn-info m-1 add-category']) ?>
            </p>
            <div class="card">
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'value' => function ($model) {
                                        return "<p class='badge badge-primary'>#{$model->value}</p>";
                                    }
                                ],
                                [
...
function init(){
    $('a.add-category').click(function(e){
        e.preventDefault();
        $('#modalTitle').html('Tambah Kategori Juknis')
    ...
    $('a.edit').click(function(e){
        e.preventDefault();
        $('#modalTitle').html('Ubah Kategori Juknis')
        let url = $(this).attr('href');
        $.get(url, function(data) {
            $('#modal').modal('show').find('#modalContent').html(data)
        });
